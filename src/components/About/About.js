				...
				<Fade duration={500}>
					<div className="container my-5">
						<Alert variant="success">
							...
							<h4 className="text-center">
								450 is all about helping you get that right amount of cofidence to start your journey and be confident about placements{" "}
					...
					<div className="container my-5">
						<h2 className="text-center">
							<a href="https://www.450dsa.com">450</a> is your personal web-based progress tracker based on <br></br>
							<i>
								<a
						...
						<h4 className="text-center my-5">
							Project by{" "}
							<a href="https://www.linkedin.com/in/suhaila10" target="_blank" rel="noopener noreferrer">
								Suhail
							</a>{" "}
